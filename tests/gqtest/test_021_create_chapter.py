...
class TestCreateChapter:
    ...
    def test_create_chapter(self, page: Page, screenshot_helper, base_url, gqkt_data: dict):
        """
        创建课程内容版
        """
        teacher_cms = gqkt_data["user"]["teacher_cms"]
        course_name = gqkt_data["course"]["课程名称"]
        ch_config = gqkt_data["chapter"]
        ...
        with allure.step("创建章"):
            ...
            screenshot_helper.capture_viewport("章创建完成")
        ...
        with allure.step("在主章下添加关联学习单元"):
            ...
            screenshot_helper.capture_viewport("主章学习单元添加完成")
        ...
        with allure.step("在该章下创建子章节"):
            ...
            screenshot_helper.capture_viewport("子章节创建完成")
        ...
        with allure.step("在子章节下添加关联学习单元"):
            ...
            screenshot_helper.capture_viewport("子章节学习单元添加完成")
        ...
        with allure.step("在该章下关联知识点章节"):
            ...
            screenshot_helper.capture_viewport("关联知识点章节完成")
        ...
        with allure.step("创建版本"):
            ...
            screenshot_helper.capture_viewport("创建版本完成")
