...
class TestReviseTrainingProgram:
    ...
    def test_revise_training_program(self, page: Page, screenshot_helper, base_url, gqkt_data: dict):
        ...
        with allure.step("修订培养方案：专业信息"):
            ...
            screenshot_helper.capture_viewport("修订培养方案：专业信息成功")
        ...
        with allure.step("修订培养方案：培养目标概述"):
            ...
            screenshot_helper.capture_viewport("修订培养方案：培养目标概述成功")

        with allure.step("修订培养方案：添加培养目标"):
            for desc in tp_info["培养目标"]["培养目标描述"]:
                tp_manage_page.add_training_goal(desc)
            screenshot_helper.capture_viewport("修订培养方案：添加培养目标成功")
        ...
        with allure.step("修订培养方案：毕业要求概述"):
            ...
            screenshot_helper.capture_viewport("修订培养方案：毕业要求概述成功")
        ...
        with allure.step("修订培养方案：添加指标点"):
            ...
            screenshot_helper.capture_viewport("修订培养方案：添加指标点成功")
        ...
        with allure.step("修订培养方案：添加目标支撑"):
            ...
            screenshot_helper.capture_viewport("修订培养方案：添加目标支撑成功")
        ...
        with allure.step("修订培养方案：添加课程"):
            ...
            screenshot_helper.capture_viewport("修订培养方案：添加课程成功")
        ...
        with allure.step("修订培养方案：课程支撑"):
            ...
            screenshot_helper.capture_viewport("修订培养方案：课程支撑成功")
