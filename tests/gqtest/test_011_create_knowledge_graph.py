...
class TestCreateKnowledgeGraph:
    ...
    def test_create_knowledge_graph(self, page: Page, screenshot_helper, base_url, gqkt_data: dict):
        ...
        with allure.step("新建知识图谱"):
            ...
            screenshot_helper.capture_viewport("新建知识图谱完成")
        ...
        #             kg_page.wait_for_element_visible(kg_page.create_success_message)
        #     screenshot_helper.capture_viewport("添加子节点完成")
